function [vep,veq] = PFHCaculate(P,Q,p0,q0,fep,feq,pn,qn,n1,d1,n2,d2,r_PFH)      %
...
%
%  输出参数
%    vep   : 目标点云PFH描述描述,第i列表示第i个特征点的PFH描述  64 * length(fep)
%    veq   : 源点云PFH特征描述,第i列表示第i个特征点的PFH描述    64 * length(fep)
%  
%
%  Author：GJT 
...
vep = pfhDescriptor(P,fep,pn,n1,d1,r_PFH);
veq = pfhDescriptor(Q,feq,qn,n2,d2,r_PFH);
