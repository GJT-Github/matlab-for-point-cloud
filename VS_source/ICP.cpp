...
void doRegistration(std::string src_cloud_path, std::string tgt_cloud_path, Eigen::Matrix4f& icp_trans)
{
    ...
    //visualize_pcd(sac_result, sac_result, sac_result);
    ...
    //可视化
    visualize_pcd(icp_result, cloud_tgt_origin, icp_result);
}

int
main(int argc, char** argv)
{
    std::string src_cloud_path = "./point_clouds/monkey.pcd";
    std::string tgt_cloud_path = "./point_clouds/monkey_downsampled.pcd";
